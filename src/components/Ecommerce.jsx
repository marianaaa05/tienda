...
import { BsCurrencyDolar } from "react-icons/bs"
import { VsPrimitiveSquare } from "react-icons/vsc"
        ...
        >
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl">$123.466.799</p>
              <earningData />
            </div>
          </div>
          <div>
          ...
          {earningData.map((item) => (
            ...
            >
              ...
              <p className="mt-3">
                ...
                <span className={`texts-sm text-${item.color} ml-2`}>
                  {item.percentage}
                </span>
              </p>
...
{/**nueva seccion */}
      <div className="flex gap-10 flex-wrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:788">
          ...
          <div className="mt-10 flex-wrap justify-center">
